...
train_parser.add_argument('data_dir', type = str, nargs='*', default = "C:/Users/VAibhAv GupTA/Artificial_Intelligence/Dog_Cat/data_dir/")
    # Choose where to save the checkpoint
train_parser.add_argument('--save_dir', action="store", dest="save_dir", default="C:/Users/VAibhAv GupTA/Artificial_Intelligence/Dog_Cat/checkpoint.pth")
